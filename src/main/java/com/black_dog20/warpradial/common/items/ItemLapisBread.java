...
public class ItemLapisBread extends BaseItem {

    public ItemLapisBread() {
    ...
    public static void onFoodEaten(LivingEntityUseItemEvent.Finish event) {
        ...
        if (!(usedItem instanceof ItemLapisBread)) return;
        WarpPlayerProperties.addFuel(player, 0.50);
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add(TranslationHelper.translate(CONTAINS_EP, TextFormatting.GRAY, 0.5));
